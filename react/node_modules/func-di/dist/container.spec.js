...
const dependencyB = token("ServiceB", { bar: "666" });
...
const aDisposer = import.meta.jest.fn(() => { });
const bDisposer = import.meta.jest.fn(() => { });
    ...
    describe("ioc container methods", () => {
        ...
        describe("consume", () => {
            it("should consume directly", () => {
                const f = import.meta.jest.fn(({ serviceA }) => {
                    return serviceA.foo();
                });
                const c = container([provide.stateful(serviceAImpl)]);
        ...
        describe("clear", () => {
            ...
            it("should handle errors in clearing", () => {
                const disposer = import.meta.jest.fn((a) => {
                    if (a.foo()) {
                        throw new Error("");
                    }
                });
                const ioc = container([
                    provide.stateful(factory(dependencyA, () => ({
                        foo() {
                            return 1;
                        },
                    }), disposer)),
